...
function baseDraw() {
    ...
    rect(
        objectXSlider.value() - 25 + width / 10,
        (3 * height) / 4 - 25,
        50,
        25
    );
...
function opticalPathDisplay(img) {
    ...
    if (lensSelect.value() == "凸レンズ") {
        if (a > (4 * width) / 10 - focusLengthSlider.value()) {
            ...
            line(
                ...
                objectY + img.height / 2,
                width - headImg.width,
                (width / 2 - headImg.width) * tan(theta_3) +
                    objectY +
                    img.height / 2
            );
            line(
            ...
            line(
                ...
                height / 2 + img.height / 2,
                width - headImg.width,
                (width / 2 - headImg.width) * tan(theta_4) +
                    height / 2 +
                    img.height / 2
            );
        ...
        if (a <= (4 * width) / 10 - focusLengthSlider.value()) {
            ...
            dashedLine(
                headImg.width,
                height / 2 -
                    (width / 2 - headImg.width) * tan(theta_1) -
                    img.height,
                width / 2,
                objectY
            );
    ...
    if (lensSelect.value() == "凹レンズ") {
        ...
        dashedLine(
            ...
            width / 2,
            height / 2 -
                ((4 * width) / 10 - focusLengthSlider.value()) * tan(theta_1)
        );
        line(
            width / 2,
            objectY,
        ...
        dashedLine(
            ...
            width - headImg.width,
            height / 2 +
                (width / 2 - headImg.width) * tan(theta_2) -
                img.height * m
        );
    ...
    if (lensSelect.value() == "半分の凸レンズ") {
        ...
        if (a <= focusLengthSlider.value()) {
            b =
                (a * focusLengthSlider.value()) /
                (focusLengthSlider.value() - a);
            m = b / a;
...
function objectAndVirtualImageDisplay(img) {
    ...
    text(
        "レンズからの距離:" +
            str(
                (15 * (1 - objectXSlider.value() / ((4 * width) / 10))).toFixed(
                    1
                )
            ) +
            " cm",
...
function screenDisplay(img) {
    ...
    text(
        "レンズからの距離:" +
            str(
                (15 * (screenXSlider.value() / ((4 * width) / 10))).toFixed(1)
            ) +
            " cm",
