//画像のオブジェクト
let headImg, convexLensImg, concaveLensImg, candleImg, fImg, ledImg;
...
function buttonSettings() {
  objectXSlider
    .size((4 * width) / 10, 2)
    .position(width / 10, windowHeight / 10 + (3 * height) / 4)
    .attribute("max", (4 * width) / 10);
  screenXSlider
    .size((4 * width) / 10, 2)
    .position(width / 2, windowHeight / 10 + (3 * height) / 4)
    .attribute("max", (4 * width) / 10);
  focusLengthSlider
    .size((4 * width) / 10, 2)
    .position(width / 10, windowHeight / 10 + (6 * height) / 10)
    .attribute("max", (4 * width) / 10);
  lensSelect
    .size((4 * width) / 10, height / 16)
    .position(width / 10, windowHeight - height / 16);
  objectSelect
    .size((4 * width) / 10, height / 16)
    .position(width / 2, windowHeight - height / 16);
}
...
function gridDraw() {
  ...
  stroke(255, 255);
  line(
    width / 2 - ((4 * width) / 10 - focusLengthSlider.value()),
    height / 2 - 30,
    width / 2 - ((4 * width) / 10 - focusLengthSlider.value()),
    height / 2 + 30
  );
  ...
  for (let i = 0; i <= 75; i++) {
    if (i % 5 == 0) {
      ...
      text(
        15 - i / 5,
        ((width / 2 - width / 10) * i) / 75 + width / 10,
        height / 2 + width / 75
      );
      text(
        i / 5,
        ((width / 2 - width / 10) * i) / 75 + width / 2,
        height / 2 + width / 75
      );
      stroke(255, 100);
      strokeWeight(1);
...
function opticalPathDisplay(img) {
  ...
  if (lensSelect.value() == "凸レンズ") {
    if (a > (4 * width) / 10 - focusLengthSlider.value()) {
      b =
        (a * ((4 * width) / 10 - focusLengthSlider.value())) /
        (a - ((4 * width) / 10 - focusLengthSlider.value()));
      m = b / a;
      ...
      line(
        ...
        objectY,
        width - headImg.width,
        objectY + (width / 2 - headImg.width) * tan(theta_1)
      );
      ...
      line(
        ...
        objectY + img.height / 2,
        width - headImg.width,
        (width / 2 - headImg.width) * tan(theta_3) + objectY + img.height / 2
      );
      line(
        objectXSlider.value() + width / 10,
        objectY,
        width - headImg.width,
        objectY + (a + width / 2 - headImg.width) * tan(theta_2)
      );
      ...
      line(
        ...
        height / 2 + img.height / 2,
        width - headImg.width,
        (width / 2 - headImg.width) * tan(theta_4) + height / 2 + img.height / 2
      );
    ...
    if (a <= (4 * width) / 10 - focusLengthSlider.value()) {
      b =
        (a * ((4 * width) / 10 - focusLengthSlider.value())) /
        ((4 * width) / 10 - focusLengthSlider.value() - a);
      m = b / a;
      theta_1 = atan(
        img.height / ((4 * width) / 10 - focusLengthSlider.value())
      );
      theta_2 = atan(img.height / a);
      dashedLine(
        headImg.width,
        height / 2 - (width / 2 - headImg.width) * tan(theta_1) - img.height,
        width / 2,
        objectY
      );
      dashedLine(
        headImg.width,
        height / 2 - (width / 2 - headImg.width) * tan(theta_2),
        objectXSlider.value() + width / 10,
        objectY
      );
      line(objectXSlider.value() + width / 10, objectY, width / 2, objectY);
  ...
  if (lensSelect.value() == "凹レンズ") {
    ...
    theta_2 = atan(
      (img.height * m) / ((4 * width) / 10 - focusLengthSlider.value())
    );
    line(objectXSlider.value() + width / 10, objectY, width / 2, objectY);
    dashedLine(
      width / 2 - ((4 * width) / 10 - focusLengthSlider.value()),
      height / 2,
      width / 2,
      height / 2 - ((4 * width) / 10 - focusLengthSlider.value()) * tan(theta_1)
    );
    line(
      width / 2,
      objectY,
    ...
    dashedLine(
      ...
      height / 2 - img.height * m,
      width - headImg.width,
      height / 2 + (width / 2 - headImg.width) * tan(theta_2) - img.height * m
    );
    ...
    line(
      ...
      objectY,
      width - headImg.width,
      height / 2 + (width / 2 - headImg.width) * tan(theta_3)
    );
  }
  ...
  if (lensSelect.value() == "縞々のスリットの凸レンズ") {
    if (a > (4 * width) / 10 - focusLengthSlider.value()) {
      ...
      if (img.height * m < lensHeight / 2) {
        ...
        if (
          height / 2 + img.height * m <
            height / 2 + candleImg.height - lensHeight / 12 ||
          height / 2 + img.height * m >
            height / 2 + candleImg.height + lensHeight / 12
        ) {
          line(
...
function objectAndVirtualImageDisplay(img) {
  ...
  stroke(255, 0, 0);
  rect(
    objectXSlider.value() - img.width / 2 + width / 10,
    objectY,
    img.width,
    img.height
  );
  ...
  text(
    "レンズからの距離:" +
      str((15 * (1 - objectXSlider.value() / ((4 * width) / 10))).toFixed(1)) +
      " cm",
    objectXSlider.value() + width / 10,
    (3 * height) / 4 + (1.5 * width) / 75
  );
  stroke(255);
  noFill();
  ...
  if (lensSelect.value() == "凸レンズ") {
    if (a <= (4 * width) / 10 - focusLengthSlider.value()) {
      ...
      translate(
        ...
        height / 2 -
          img.height +
          (width / 2 - headImg.width) *
            tan(
              atan(img.height / ((4 * width) / 10 - focusLengthSlider.value()))
            )
      );
      rotate(PI / 10);
      image(headImg, 0, 0);
...
function screenDisplay(img) {
  ...
  text(
    "レンズからの距離:" +
      str((15 * (screenXSlider.value() / ((4 * width) / 10))).toFixed(1)) +
      " cm",
    screenXSlider.value() + (5 * width) / 10,
    (3 * height) / 4 + (1.5 * width) / 75
  );
  stroke(255);
  if (lensSelect.value() != "凹レンズ") {
    if (a > (4 * width) / 10 - focusLengthSlider.value()) {
      ...
      image(
        pg,
        screenXSlider.value() + width / 2 - screenHeight / 2 + screenWidth / 2,
      ...
      fill(100);
      rect(
        screenXSlider.value() + width / 2 - 25,
        (3 * height) / 4 - 25,
        50,
        25
      );
        ...
        if (i % 5 == 0) {
          ...
          line(
            screenXSlider.value() +
              ...
              screenHeight / 2 +
              screenWidth / 2,
            height / 2 - screenHeight + (height / (4 * 20)) * i - 10,
            screenXSlider.value() +
              width / 2 +
              screenHeight / 2 +
              screenWidth / 2 +
      ...
      noFill();
      rect(
        screenXSlider.value() + width / 2 + screenWidth / 2 - img.width / 2,
        height / 2 - screenHeight - 10,
        img.width,
        img.height
      );
...
function focusDraw(img) {
  ...
  text(
    "focus",
    width / 2 - ((4 * width) / 10 - focusLengthSlider.value()),
    height / 2 + width / 50 + (1.5 * width) / 75
  );
  text(
    "焦点距離:" +
      str(
        map(
          (4 * width) / 10 - focusLengthSlider.value(),
          (4 * width) / 10,
          0,
          15,
          0
