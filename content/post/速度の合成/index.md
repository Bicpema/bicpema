...
<p style="text-align:center;"><strong>v</strong><sub>合成</sub> = <strong>v</strong><sub>川</sub> + <strong>v</strong><sub>船</sub></p>

このシミュレーションでは以下のパラメータを調整できます:

- **川の速度** (v<sub>川</sub>): 川の流速（左向き固定、0〜10 m/s）
- **船の速度** (v<sub>船</sub>): 船が水に対して進む速度（＋＝下流左向き、−＝上流右向き、−10〜+10 m/s）

シミュレーションでは、赤色の矢印が川の速度 (v<sub>川</sub>)、緑色の矢印が船の速度 (v<sub>船</sub>)、青色の矢印が合成速度 (v<sub>合</sub>) を示します。
...
- 船が上流へ向かう速度が川の流速と等しいとき（|v<sub>船</sub>| = v<sub>川</sub>）、合成速度が 0 になり、岸から見ると船は静止して見えます
