...
$$F_b = \rho_{\text{流体}} \cdot V_{\text{排除}} \cdot g$$

ここで:

- $\rho_{\text{流体}}$: 流体（水）の密度
- $V_{\text{排除}}$: 物体が排除した流体の体積（水中にある部分の体積）
- $g$: 重力加速度
...
- **浮力 > 重力**（ $\rho_{\text{物体}} < \rho_{\text{流体}}$ ）: 物体は浮く
- **浮力 = 重力**（ $\rho_{\text{物体}} = \rho_{\text{流体}}$ ）: 物体は静止（中性浮力）
- **浮力 < 重力**（ $\rho_{\text{物体}} > \rho_{\text{流体}}$ ）: 物体は沈む
